...
// Debounced save after a batch of edits settles, on top of the explicit
// Save button. Failures are silent here — the explicit action is what
// surfaces errors to the user via toast.
