...
//
// Read-only, including for the track's own owner -- deleting a lap time
// (even your own track's) is a moderation power reserved for the admin
// dashboard, not something a track owner gets to exercise over other
// racers' scores.
